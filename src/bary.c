...
/* barycentric times using TEMPO.                    */
{
   ...
   if (argc < 4) {
      ...
      printf("   Convert topocentric times (from stdin) to barycentric times.\n\n");
      printf("   Arguments:\n");
      printf("     observatory is a 2 letter ITOA observatory code in obsys.dat\n");
      printf("     ra is a string with J2000 RA in the format 'hh:mm:ss.ssss'\n");
      printf("     dec is a string with J2000 DEC in the format 'dd:mm:ss.ssss'\n");
